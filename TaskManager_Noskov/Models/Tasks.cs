...
namespace TaskManager_Noskov.Models
{
    public class Tasks : Notification
    {
        ...
        public string Priority
        {
            ...
            set
            {
                ...
                if (!match.Success)
                    MessageBox.Show("Приоритет не должно быть пустым, и не более 30 символов.", "Не корректный ввод значения");
                else
                {
                    priority = value;
